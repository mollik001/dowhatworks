...
class CustomProtocolLaunchView extends GetView<CustomProtocolController> {
  const CustomProtocolLaunchView({super.key});
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 24.h),
          _buildStepIndicators(selectedStep: 3),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8.h),
                  Text(
                    controller.hypothesisController.text,
                    style: TextStyle(
                  ...
                  SizedBox(height: 8.h),
                  Obx(() {
                    final durations = ['3 days', '7 days', '14 days', '21 days'];
                    return Wrap(
                      spacing: 8.w,
                      runSpacing: 8.h,
                      children: durations.map((d) {
                        final isSelected = controller.duration.value == d;
                        return GestureDetector(
                          onTap: () => controller.setDuration(d),
                          child: Container(
                            padding: EdgeInsets.symmetric(horizontal: 12.w, vertical: 8.h),
                            decoration: BoxDecoration(
                              color: isSelected ? const Color(0xFF21140F) : const Color(0xFF0F0F0F),
                              borderRadius: BorderRadius.circular(12.r),
                              border: Border.all(
                                color: isSelected ? const Color(0xFFF26B3A) : Colors.white.withValues(alpha: 0.08),
                                width: 1,
                              ),
                            ),
                            child: Text(
                              d,
                              style: TextStyle(
                                color: isSelected ? const Color(0xFFF26B3A) : Colors.white.withValues(alpha: 0.65),
                                fontFamily: 'Inter',
                                fontWeight: FontWeight.w400,
                                fontSize: 12.sp,
                                height: 1.375,
            ...
            children: [
              IntrinsicWidth(
                child: GestureDetector(
                  onTap: () => Get.offNamed(AppRoutes.customProtocolMetric),
                  child: Container(
