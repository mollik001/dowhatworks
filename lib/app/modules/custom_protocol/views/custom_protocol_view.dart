...
class CustomProtocolView extends GetView<CustomProtocolController> {
  const CustomProtocolView({super.key});
          ...
          Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Enter your hypothesis...',
                hintStyle: TextStyle(
              ...
              for (int i = 0; i < steps.length; i++)
                Expanded(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: i <= controller.selectedStep.value
